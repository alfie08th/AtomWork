...
Public Class MouseAction
    ...
    Public Overrides Function toString() As String
        Select Case MainType
            Case MouseAction.L
                Return "Mouse Left >> " & p.ToString
            Case MouseAction.DL
                Return "Mouse Double Left >> " & p.ToString
            Case MouseAction.R
                Return "Mouse Rigth >> " & p.ToString
            Case MouseAction.DR
                Return "Mouse Double Rigth >> " & p.ToString
            Case MouseAction.M
                Return "Mouse Middle >> " & p.ToString
            Case MouseAction.DM
                Return "Mouse Double Middle >> " & p.ToString
            Case MouseAction.S
                Select Case ScrolType
                    Case ScrolDir.down
                        Return "Scrol Down >> " & p.ToString
                    Case ScrolDir.up
                        Return "Scrol Up >> " & p.ToString
                End Select
        End Select
...
Public Class KeyAction
    ...
    Public Overrides Function ToString() As String
        Return "Key Down >> " & MainKey.ToString
    End Function
End Class
